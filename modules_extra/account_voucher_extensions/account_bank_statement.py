...
class account_bank_statement(osv.osv):
    ...
    def _calc_sum(self, cr, uid, ids, field_name, arg=None, context=None):
        ...
        for statement in self.browse(cr, uid, ids):
            ...
            res_sub['sum_customer_lines'] = sum_customer
            res_sub['sum_supplier_lines'] = sum_supplier
            res_sub['sum_general_lines'] = sum_general
            res[statement.id] = res_sub
        return res
        
    _columns = {
        'sum_customer_lines': fields.function(_calc_sum, type='float', string='Sum Customer', multi='sum'),
		'sum_supplier_lines': fields.function(_calc_sum, type='float', string='Sum Suppliers', multi='sum'),
		'sum_general_lines': fields.function(_calc_sum, type='float', string='Sum General', multi='sum'),
    }
