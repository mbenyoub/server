...
class account_invoice_line(osv.osv):
    ...
    _columns = {
            ...
            'account_ch_id' : fields.related('invoice_id','journal_id','charge_account_id', type='many2one', obj='account.account', string='Account Charge', help="Credit account to make a aditional journal entry like to charge account"),
        }
    ...
    def _refund_cleanup_lines(self, cr, uid, lines, context=None):
        ...
        for r in res:
            for field in ('account_cc_id',):
                r[2][field] = lines[i]._data.get(field, False) and lines[i][field][0]
            i+=1
        return res
