...
class product_product(osv.osv):
    ...
    _columns = {
        ...
        # MODIFICACION 10/04/2015
        'tolerance_percent': fields.float('Porcentaje de tolerancia',
            help="Porcentaje de tolerancia de peso esperado en la compra del producto"),
