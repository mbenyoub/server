...
#    Code by Ivan Macias <ivanfallen79@gmail.com>
#
...
class sale_order_line_make_invoice(osv.osv_memory):
    """
        Inherit sale_order_line_make_invoice - Agregar la relacion entre el documento venta con factura.
    """
