...
class delivery_config_settings(osv.Model):
    ...
    def get_setting_payment(self, cr, uid, context=None):
        """
            Obtiene la configuración del pago en logistica
        """
        res = {
        ...
        if config_id:
            config = self.browse(cr, uid, config_id, context=context)
            res['payments_enable'] = config.payments_enable
            res['journal_id'] = config.journal_id and config.journal_id.id or False
            
        val = False
        # Valida que tenga un diario asignado
        if not res.get('journal_id',False):
            raise osv.except_osv(_('Error!'),_("No tiene un diario asignado en la configuración"))
    ...
    _columns = {
        ...
        'payments_enable': fields.boolean('Permitir pagos'),
    ...
    def get_default_color1(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id= self.browse(cr, uid, data).color1
        return {'color1': reg_id or False}
    ...
    def get_default_color2(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).color2
        return {'color2': reg_id or False}
    ...
    def get_default_color3(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).color3
        return {'color3': reg_id or False}
    ...
    def get_default_color4(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).color4
        return {'color4': reg_id or False}
    ...
    def get_default_color5(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).color5
        return {'color5': reg_id or False}
    ...
    def get_default_week1(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).week1
        return {'week1': reg_id or False}
    ...
    def get_default_week2(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).week2
        return {'week2': reg_id or False}
    ...
    def get_default_week3(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).week3
        return {'week3': reg_id or False}
    ...
    def get_default_week4(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).week4
        return {'week4': reg_id or False}
    ...
    def get_default_week5(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).week5
        return {'week5': reg_id or False}
    ...
    def get_default_week6(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).week6
        return {'week6': reg_id or False}
    ...
    def get_default_week7(self, cr, uid, fields, context=None):
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).week7
        return {'week7': reg_id or False}
    
    def get_default_payments_enable(self, cr, uid, fields, context=None):
        """
            Obtiene el valor por default del registro
        """
        reg_id = False
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg_id = self.browse(cr, uid, data).payments_enable
        return {'payments_enable': reg_id or False}
    
    def get_default_journal_id(self, cr, uid, fields, context=None):
        """
            Obtiene el valir por default del registro
        """
        reg = False
        cr.execute(
            """ select max(id) as conf_id from delivery_config_settings """)
        ...
        data = dat and dat[0]['conf_id'] or False
        if data:
            reg = self.browse(cr, uid, data).journal_id.id or False
        return {'journal_id': reg or False}
