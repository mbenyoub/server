...
class delivery_route_paid_log(osv.Model):
    ...
    #def add_log_paid_route(self, cr, uid, route_id, invoice, residual, context=None):
    #    """
    #        Crea los registros de los pagos en la ruta
    #    """
    #    route_line_obj = self.pool.get('delivery.route.line')
