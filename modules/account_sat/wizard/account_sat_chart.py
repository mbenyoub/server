...
class account_sat_chart(osv.osv_memory):
    """
        For Chart of Accounts
    """
    _name = "account.sat.chart"
    _description = "Account SAT chart"
    _columns = {
        'fiscalyear': fields.many2one('account.fiscalyear', \
                                    'Ejercicio Fiscal',  \
                                    help='Dejarlo vacio para abrir todos los ejercicios fiscales'),
    ...
    def _get_fiscalyear(self, cr, uid, context=None):
        """
            Obtiene el ejercicio fiscal por default
        """
    ...
    def account_chart_open_window(self, cr, uid, ids, context=None):
        """
            Retorna el plan de cuentas sat con la informacion de cargos y abonos calculados en el periodo marcado
        """
        ...
        result = mod_obj.get_object_reference(cr, uid, 'account_sat', 'action_account_sat_tree')
