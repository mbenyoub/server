...
del Service._services['report.lot.stock.overview']

report_sxw.report_sxw('report.lot.stock.overview', 'stock.location', 'addons/stock_location_extra/report/lot_overview.rml', parser=lot_overview,header='internal')
