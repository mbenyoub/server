...
function openerp_pos_screens(instance, module){ //module is instance.point_of_sale
    ...
    module.ScreenWidget = module.PosBaseWidget.extend({
        ...
        show: function(){
            ...
            //ADD AKKADIAN - Valida si debe mostrar los botones de descuento y precio
            if (!this.pos.iface_apply_discount) {
                document.getElementById("numpad-discount").disabled = true;
                document.getElementById("numpad-price").disabled = true;
            }
    ...
    module.ClientPaymentScreenWidget =  module.ScreenWidget.extend({
        ...
        show: function(){
            ...
            document.getElementById("payment-paid-total").innerHTML = "10";
    ...
    module.PaymentScreenWidget = module.ScreenWidget.extend({
        ...
        validateCurrentOrder: function() {
            ...
            //ADD AKKADIAN - Valida si tiene un diario con credito le dice que no
            var JSON = currentOrder.exportAsJSON()
            if (!JSON) {
                this.back();
            }
            else {
                this.pos.push_order(JSON)
                currentOrder.set_client(undefined);
